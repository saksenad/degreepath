...
for course in courses:
  ...
  if result == 0:
    ...
    query = "INSERT INTO courses(subject, course_number, name, credit_hours, course_CRN) VALUES('"+course['subject_code']+"', '"+course['course_number']+"', '"+course['course_title'].replace("'", "")+"', "+credit_hours+", "+course['crn']+");"
    cur.execute(query)
